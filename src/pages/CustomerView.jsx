...
export default function CustomerView ({ customer, setPage, updateCustomer, data }){
    ...
    return (
        <div className="space-y-6">
            <button onClick={() => setPage('customers')} className="flex items-center text-blue-600 hover:text-blue-800 font-medium mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow-lg">
                    <h3 className="text-xl font-semibold border-b pb-2 mb-4">Order History ({customerOrders.length})</h3>
